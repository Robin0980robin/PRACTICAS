...
export class ProductoService {
  ...
  async buscarProductos(query: string): Promise<Producto[]> {
    ...
    return this.productoRepo
      ...
      .where('LOWER(producto.nombre_generico) LIKE :search', { search: searchTerm })
      .orWhere('LOWER(producto.nombre_comercial) LIKE :search', { search: searchTerm })
      .orWhere('LOWER(producto.principio_activo) LIKE :search', { search: searchTerm })
      .orWhere('LOWER(producto.categoria) LIKE :search', { search: searchTerm })
      .getMany();
  }
}
